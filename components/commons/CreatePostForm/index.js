                    ...
                    <form onSubmit={handleSubmit}>
                        <div className={styles.title}>
                            ...
                            <div className={styles.name}>
                                ...
                                <select value={private} onChange={(event)=>{setPrivate(event.target.value)}}>
                        ...
                        <div className={styles.groupButton}>
                            ...
                            <div className={styles.right}>
                                ...
                                <label for="tags"><FontAwesomeIcon className={styles.iconTag} icon={faUser}></FontAwesomeIcon></label>
                                <input id="tags[]" type="button"></input>
